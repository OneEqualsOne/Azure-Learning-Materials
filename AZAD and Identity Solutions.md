...
-   **AZ AD Registered** – provide users with support for BYOD 
-   **AZ AD Joined** – joined through an org account. Devices generally are owned by the org 
-   **Hybrid AZ AD joined** – joined to on-prem and AZ AD using the same org account 
...
- **AZ AD Pass through** - directly validating password of user againsed the on-prem AD environment, not in cloud
...
![[Pasted image 20221013101022.png]]
...
## Benefits of AZ AD roles and RBAC  
...
Categories of AZ AD roles:
- **Azure AD specific** – manage resources in AZ AD only 
- **Service specific roles** – for services 
- **Cross-service roles** – AZ AD span through services  

### Difference between AZ AD RBAC AND AZ RBAC 
...
# Identity protection and governance in AZ AD 
...
### Identity lifecycle: 
![[Pasted image 20221013101211.png]]
